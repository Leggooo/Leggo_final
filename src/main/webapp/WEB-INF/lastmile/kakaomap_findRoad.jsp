...
<meta name="viewport" content="width=1024" />
	...
	<link rel="stylesheet" href="//t1.daumcdn.net/kakaomapweb/map/202001091516517/app_A.css">
	<link rel="stylesheet" href="//t1.daumcdn.net/kakaomapweb/map/202001091516517/app_B.css">
    <link rel="stylesheet" href="//t1.daumcdn.net/kakaomapweb/map/202001091516517/app_C.css">
    <link rel="stylesheet" href="//t1.daumcdn.net/kakaomapweb/map/202001091516517/app_D.css">
            <link rel="stylesheet" href="//t1.daumcdn.net/kakaomapweb/map/202001091516517/canvas_roadview.css">
...
if (false === true && (false === false || $needAgreements) && document.referrer.split('?')[0] === "https://accounts.kakao.com/login/kakaomap?continue=".split('?')[0]) {
...
<div id="info" class="Info">
    ...
    <div id="info.flagsearch" class="HIDDEN Flagsearch">
        <div class="search">
            ...
            <div id="info.noW3w" class="noPlace noPlace_type2 "><!--2019-04-12 : w3w 빈페이지 - noPlace_type2 클래스 추가 -->
                <div class="inner_noPlace">
    ...
    <div id="info.notice" class="notice">
        ...
        <div class="noticeList">
            <ul>
                        ...
                        <a href="https://kakaomap.tistory.com/300" target="_blank">신종 코로나바이러스감염증 선별진료소 위치정보 지원</a>
                    </li>
                                    <li id="info.main.notice.text2">
                        <span class="ico_notice">공지</span>
                        <a href="https://kakaomap.tistory.com/281" target="_blank">[카카오맵APP] 톡친구 위치공유 기능 오픈!</a>
                    </li>
                            </ul>
                ...
                <div id="localInfo.map.weather" class="tempInfo">
                    <div class="center">
                        ...
                        <img id="localInfo.map.weatherIcon" class="weatherImg HIDDEN" alt=""
                             src="//i1.daumcdn.net/dmaps/apis/transparent.gif"/>
...
<form id="flash_scrap_form" name="flash_scrap_form" method="post" action="./etc/scrap.jsp" target="_self">
    ...
    <div id="subwayoverviewer" class="Subwayoverviewer HIDDEN">
        <img id="subwayoverviewer.image" class="SubwayoverviewerImage" alt=""
                 src="//i1.daumcdn.net/dmaps/defaultimg/transparent.gif" >
...
<script type="text/javascript" src="//t1.daumcdn.net/kakaomapweb/map/202001091516517/app.js"></script>
...
params:{"rt2":"카카오","rt":",,523953,1084098","rt1":""}||{},
options:{
    isLogin: 0,
    isMapUser: 0,
	...
	thememapPlaces: [{id: '84', title: '주말에 떠나는 전주 맛집 기행', banner: 'http://t1.daumcdn.net/localimg/localimages/07/2014/theme/140826_69_pc.png', thumbnail: 'http://cfile25.uf.tistory.com/image/0357E64C50F4F90316C073', placeCount: '37', region: '전라' } , {id: '2', title: '30년 이상 맛집', banner: 'http://t1.daumcdn.net/localimg/localimages/07/2014/theme/140826_01_pc.png', thumbnail: 'http://cfile23.uf.tistory.com/image/111BF0134B94A6B7225A4F', placeCount: '36', region: '전국' } , {id: '91', title: '사계절 아름다운 계룡산 탐방', banner: 'http://t1.daumcdn.net/localimg/localimages/07/2014/theme/141027_pctop.png', thumbnail: 'http://cfile2.uf.daum.net/image/215D543F544D9853046246', placeCount: '39', region: '충청' }   ],
	gasPrice: {avgGasPrice: 1563.1329, avgDieselPrice: 1390.7646, avgLpgPrice: 874.2691,
			gasDate: "2020-02-05", dieselDate: "2020-02-05", lpgDate: "2020-02-05"},
